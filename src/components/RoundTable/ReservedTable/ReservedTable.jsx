...
const ReservedTable = (props, handleReservationSave) => {
  ...
  return (
    <>
      <div
        className="table w-40 h-40 md:w-48 md:h-48  before:bg-reserved-100 after:bg-reserved-100   mb-10"
        style={{ backgroundColor: "#ccc" }}
      >
        <div className="content text-white bg-reserved-200">
          <div className="table_info">
            ...
            <button
              ...
              className="table_button pt-2 pb-1 text-xl border-b-4 border-reserved-200 hover:border-reserved-100  transition-all duration-300 "
